document.addEventListener("DOMContentLoaded", function() {
    ...
    function startTimer() {
      ...
      timer = setInterval(function() {
        ...
        if (intervals[currentIntervalIndex] > 0) {
          ...
          startTimer();
          document.getElementById('sailor-cat').src = './images/kiki.png'; // Change the image source 
    ...
    function updateTimeDisplay() {
      ...
      document.getElementById('sailor-cat').src = './images/grey.png'; // Change the image source 
    }
